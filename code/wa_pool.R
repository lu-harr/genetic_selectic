...
# write.csv(progress_auc, "output/wa_auc_pool1000_iters100_runs10.csv", row.names=FALSE)
# 
# save(times1000,
#      final_fronts1000,
#      file="output/diagnostics_wa_pool.rds")
# 
# # pool size 5000
...
#   t2 = Sys.time()
#   t2-t1}
# write.csv(progress_auc, "output/wa_auc_pool5000_iters100_runs10.csv", row.names=FALSE)
# 
...
# write.csv(progress_auc, "output/wa_auc_pool10000_iters100_runs10.csv", row.names=FALSE)
# 
...
{set.seed(834903)
  ...
  t2 = Sys.time()
  t2-t1}
write.csv(progress_auc, "output/wa_auc_pool50000_iters100_runs10.csv", row.names=FALSE)
