...
# write.csv(progress_auc, "output/wa_auc_pool1000_iters100_runs10_trapezoid.csv", row.names=FALSE)
# 
# save(times1000,
#      final_fronts1000,
#      file="output/diagnostics_wa_pool_trapezoid.rds")
# 
# # pool size 5000
...
#   t2 = Sys.time()
#   t2-t1}
# write.csv(progress_auc, "output/wa_auc_pool5000_iters100_runs10_trapezoid.csv", row.names=FALSE)
# 
...
# write.csv(progress_auc, "output/wa_auc_pool10000_iters100_runs10_trapezoid.csv", row.names=FALSE)
# 
# save(times1000, times5000, times10000,
#      final_fronts1000, final_fronts5000, final_fronts10000,
#      file="output/diagnostics_wa_pool_trapezoid.rds")

load("output/diagnostics_wa_pool_trapezoid.rds")
...
{set.seed(834903)
  ...
  t2 = Sys.time()
  t2-t1}
write.csv(progress_auc, "output/wa_auc_pool50000_iters100_runs10_trapezoid.csv", row.names=FALSE)
