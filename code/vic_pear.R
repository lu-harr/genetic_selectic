...
write.csv(progress_auc, "output/vic_auc_pool100000_iters100_runs10_neigh3_greedystart.csv", row.names=FALSE)
save(times_pear,
     final_fronts_pear,
     file="output/diagnostics_vic_100000_neigh3_greedy.rds")