...
#                          plot_out = FALSE)
#     tend <- Sys.time()
#     message(paste("greedy: ", ind, ";",tend-tstart))
...
#   t2-t1}
# 
# write.csv(progress_auc, "output/vic_auc_pool50000_iters100_runs10_neigh3_greedystart.csv", row.names=FALSE)
# save(times_pear,
#      final_fronts_pear,
#      file="output/diagnostics_vic_50000_neigh3_greedy.rds")
...
write.csv(progress_auc, "output/vic_auc_pool100000_iters100_runs10_neigh3_greedystart_trapezoid.csv", row.names=FALSE)
save(times_pear,
     final_fronts_pear,
     file="output/diagnostics_vic_100000_neigh3_greedy_trapezoid.rds")