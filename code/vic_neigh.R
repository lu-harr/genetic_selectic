...
{set.seed(834903)
  ...
  t2 = Sys.time()
  t2-t1}
write.csv(progress_auc, "output/vic_auc_pool1000_iters100_runs10_neigh2_trapezoid.csv", row.names=FALSE)

save(times_neigh2,
     final_fronts_neigh2,
     file="output/diagnostics_vic_neigh_trapezoid.rds")
...
{set.seed(834903)
  ...
  t2 = Sys.time()
  t2-t1}
write.csv(progress_auc, "output/vic_auc_pool1000_iters100_runs10_neigh3_trapezoid.csv", row.names=FALSE)
...
{set.seed(834903)
  ...
  t2 = Sys.time()
  t2-t1}
write.csv(progress_auc, "output/vic_auc_pool1000_iters100_runs10_neigh4_trapezoid.csv", row.names=FALSE)
...
{set.seed(834903)
  ...
  t2 = Sys.time()
  t2-t1}
write.csv(progress_auc, "output/vic_auc_pool1000_iters100_runs10_neigh5_trapezoid.csv", row.names=FALSE)
